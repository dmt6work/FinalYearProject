...
while (1==1)
    ...
    if (choice==1)
        ...
        xx = 1;
        for k=1:120
            I = imread(sprintf('C:/Users/DELL/Desktop/Project/Codes/1(Paddy)/Paddy-Leaf-Disease-Detection-Using-SVM-Classifier-master/Train/Img/Train (%d).jpg', k));
